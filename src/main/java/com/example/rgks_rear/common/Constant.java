package com.example.rgks_rear.common;

// 常量定义
public class Constant {
    public static final String MsgSaveSuccess = "success";
    public static final String MsgQuerySuccess="success";
    public static final String MsgDeleteSuccess="success";
    ...
    public static final String DeleteSuccess = "200";
